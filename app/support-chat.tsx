...
const BOT_REPLIES: Record<string, string> = {
  ...
  fee: 'WERKR berechnet eine Plattformgebühr von nur 8% — eine der niedrigsten im deutschen Markt. Die Gebühr wird vom Anbieter-Auszahlungsbetrag abgezogen. Kunden zahlen keinen Aufschlag.\n\nPro-Anbieter (€29/Monat) erhalten zusätzlich Featured-Platzierung, detaillierte Analytics und Prioritätssupport.',
};
