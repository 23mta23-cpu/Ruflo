...
import {
  ...
  TextInput, StyleSheet, KeyboardAvoidingView, Platform, Animated,
} from 'react-native';
...
// Seed messages – replaced by Supabase subscription once backend is live
...
export default function ChatScreen() {
  ...
  function handleSend() {
    ...
    const msg: Message = { id: Date.now().toString(), from: 'customer', text, time };
    ...
    // TODO: replace with supabase.from('messages').insert({ job_id: jobId, ...msg })
  }
