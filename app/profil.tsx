...
export default function ProfilScreen() {
  ...
  // Name und E-Mail -- und ohne eine einzige Anmelde-Moeglichkeit
  ...
  if (!user) {
    return (
      <SafeAreaView style={styles.container} edges={['top']}>
        ...
        <GastLoginHinweis
          text="Melden Sie sich an, um Aufträge zu vergeben, Nachrichten zu lesen und Zahlungen zu verwalten. Das Stöbern bleibt auch ohne Konto möglich."
          mitRegistrierung
        />
      </SafeAreaView>
    );
