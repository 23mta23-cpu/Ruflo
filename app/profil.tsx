...
const styles = StyleSheet.create({
  ...
  bio:            { ...T.bodySmall, color: C.sub, textAlign: 'center', marginBottom: 16, paddingHorizontal: 8 },
  ratingLeft:     { alignItems: 'center', flex: 1 },
  ratingBars:     { flex: 1.6 },
  ratingBarRow:   { flexDirection: 'row', alignItems: 'center', gap: 5, marginBottom: 5 },
  ratingBarLabel: { ...T.caption, color: C.sub, width: 10, textAlign: 'right' },
  ...
  trade:          { ...T.body, color: C.sub, marginBottom: 16 },
  ...
  tabText:        { ...T.bodySmall, color: C.muted, fontWeight: '500' },
  ...
  servicePrice:   { ...T.body, fontWeight: '700', color: C.ink },
  ...
  reviewAuthor:   { ...T.bodySmall, fontWeight: '700', color: C.ink },
  reviewDate:     { ...T.caption, color: C.muted },
  reviewText:     { ...T.bodySmall, color: C.sub, marginTop: 6 },
