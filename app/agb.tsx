...
(4) Wie wir prüfen. Meldungen nach Absatz 5 und Beschwerden nach §7 Absatz 5 werden von Menschen geprüft; über Maßnahmen darauf entscheidet ein Mensch. Eine Ausnahme gibt es, und wir nennen sie hier: Erkennt die Prüfung im Chat dreimal innerhalb von 12 Monaten Kontakt- oder Zahlungsdaten, wird der Strike nach §7 Absatz 2 ohne Zutun eines Menschen vergeben, und ab drei gleichzeitig aktiven Strikes sind keine neuen Angebote mehr möglich. Der einzelne Treffer bleibt folgenlos und erzeugt nur den Hinweis im Chat. Jeder so vergebene Strike trägt die Begründung nach §7 Absatz 4, verfällt nach 12 Monaten von selbst, und Sie können nach §7 Absatz 5 die Überprüfung durch einen Menschen verlangen. Diese eine automatisierte Entscheidung ist in der Datenschutzerklärung unter „Automatisierte Entscheidungen" vollständig offengelegt (Art. 22 DSGVO). Setzen wir darüber hinaus automatisierte Mittel ein, wird das in der Begründung nach Absatz 6 ausdrücklich genannt.
