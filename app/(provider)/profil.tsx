...
const styles = StyleSheet.create({
  ...
  changePhotoBtn:  { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 6, paddingHorizontal: 14, paddingVertical: 7, minHeight: 44, backgroundColor: C.surface, borderWidth: 1, borderColor: C.border, borderRadius: 8 },
